...
void
warthog::cpd::reverse_oracle::compute_row(
...
void
warthog::cpd::reverse_oracle::add_row(uint32_t target_id,
...
//    std::cerr << "compressed target row " << source_id << " with "
//        << fm_.at(target_id).size() << std::endl;
}

std::istream&
warthog::cpd::operator>>(std::istream& in,
        warthog::cpd::reverse_oracle& lab)
{
...
warthog::cpd::reverse_oracle::operator+=(const warthog::cpd::reverse_oracle &cpd)
{
