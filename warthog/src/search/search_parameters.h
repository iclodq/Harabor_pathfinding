#ifndef WARTHOG_SEARCH_PARAMETERS_H
#define WARTHOG_SEARCH_PARAMETERS_H
...
struct search_parameters
{
    public:
        ...
        // (in nanoseconds)
        inline void
        set_max_time_cutoff(double nanos) { time_cutoff_ns_ = nanos; }

        inline double
        get_max_time_cutoff() { return time_cutoff_ns_; }
        ...
        inline void
        set_max_cost_cutoff(warthog::cost_t cutoff) { cost_cutoff_ = cutoff; }

        inline warthog::cost_t
        get_max_cost_cutoff() { return cost_cutoff_; }
        ...
        inline double
        get_w_admissibility() { return w_admissibility_; }
        ...
        // factor of epsilon >= 0
        inline void
        set_eps_admissibility(warthog::cost_t epsilon)
        {
            assert(epsilon >= 0);
    ...
    private:
        ...
        warthog::cost_t eps_admissibility_ = 0;
